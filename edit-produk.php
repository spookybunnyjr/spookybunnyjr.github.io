...
<html>
    ...
    <body>
        ...
        <header>
            <div class="container">
            <h1><a href="dashboard.php">LACOL</a></h1>
            <ul>
            ...
            <div class="container">
               ...
               <?php
                    if(isset($_POST['submit'])){
                            ...
                            //jika admin ganti gambar maka lakukan
                            ...
                            //kondisi admin tidak ganti gambar
                            $namagambar = $foto;
                        }
                        ...
                        if($update){
                            echo '<script>alert("Ubah Data Berhasil Dilakukan")</script>';
                                echo '<script>window.location="data-produk.php"</script>';
                                    }else{
