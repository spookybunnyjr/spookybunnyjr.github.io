               ...
               <?php
                    if(isset($_POST['submit'])){
                       ...
                       if(!in_array($type2, $tipe_diizinkan)){
                        ...
                        //jika format file sesuai dengan array tipe diizinkkan
                        //proses up  file + insert db
                            echo '<script>alert("File anda telah berhasil masuk dalam database Lacol.com")</script>';
